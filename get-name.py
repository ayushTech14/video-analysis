...
# Start FFmpeg stream
def stream_video_to_virtual_camera(video_path, device, fps):
    command = [
        'sudo', 'ffmpeg',
        '-stream_loop', '-1',
        '-re',
...
if __name__ == "__main__":
    ...
    threading.Thread(target=stream_video_to_virtual_camera, args=(video_path, device, fps_value), daemon=True).start()
